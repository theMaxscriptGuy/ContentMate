...
const sections = [
  ...
  },
  {
    ...
    body: [
      "We may impose usage limits, daily limits, quotas, rate limits, feature limits, or access restrictions. We may change, suspend, or discontinue any part of the Service at any time. The current v1 Service may limit users to two analyses per user per day."
    ]
  },
  {
  ...
  {
    title: "10. Indemnity and Termination",
    body: [
  ...
  {
    title: "11. Governing Law, Changes, and Contact",
    body: [
